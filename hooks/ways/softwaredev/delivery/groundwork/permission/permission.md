...
2. **Do not compensate with a primitive.** Another agent, a longer prompt, or a wrapper around the broken step hides the boundary and adds something else to maintain.
...
4. **Watch for the standing intervention.** If a leader has to step in every time to get a change deployed, that dependency is itself a missing condition. Put it in the report.
