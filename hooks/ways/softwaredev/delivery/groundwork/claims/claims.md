...
We grade the evidence. A polished writeup tells us how much care the author took. It tells us nothing about whether the change works.
...
An item that can answer all three is a different kind of object from one that answers only the first. Sort by that.
...
The `skeptic` agent runs this pass on a finished deliverable, working from primary sources and stopping at could-not-refute. This way is the same posture applied while the work is still moving.

## Common Rationalizations

| Rationalization | Counter |
|---|---|
| "The description is thorough and clearly written" | Find the line that could fail. |
| "The author is experienced" | Then their evidence should be easy to find. Ask for it. |
