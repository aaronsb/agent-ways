...
| [ADR-137](./system/ADR-137-bounded-poll-contract-for-external-sensors-over-remote-collections.md) | Bounded-poll contract for external sensors over remote collections | Draft |
