...
| [ADR-137](./system/ADR-137-external-sensors-poll-conditional-feeds-not-collection-scans.md) | External sensors poll conditional feeds, not collection scans | Draft |
